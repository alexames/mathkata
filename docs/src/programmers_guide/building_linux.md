Building for Linux    {#mathkata_guide_building_linux}
==================

# Version Requirements    {#mathkata_guide_building_linux_version}
...
# Prerequisites    {#mathkata_guide_building_linux_prerequisites}
...
# Building    {#mathkata_guide_building_linux_building}
...
`mathkata/CMakeLists.txt` by using [CMake]'s `-D` option.
...
# Running Applications    {#mathkata_guide_building_linux_running}
