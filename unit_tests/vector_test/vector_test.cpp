...
TEST_F(VectorTests, kDims) {
  EXPECT_EQ(static_cast<int>(mathfu::Vector<float, 2>::kDims), 2);
  EXPECT_EQ(static_cast<int>(mathfu::Vector<float, 3>::kDims), 3);
  EXPECT_EQ(static_cast<int>(mathfu::Vector<float, 4>::kDims), 4);
}
