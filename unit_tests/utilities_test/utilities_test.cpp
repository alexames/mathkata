...
TEST_F(UtilitiesTests, RoundUpToTypeBoundary_ReturnType) {
  auto result = mathfu::RoundUpToTypeBoundary<int>(0);
...
TEST_F(UtilitiesTests, RoundUpToTypeBoundary_Zero) {
  EXPECT_EQ(0u, mathfu::RoundUpToTypeBoundary<char>(0));
  EXPECT_EQ(0u, mathfu::RoundUpToTypeBoundary<int16_t>(0));
  EXPECT_EQ(0u, mathfu::RoundUpToTypeBoundary<int32_t>(0));
  EXPECT_EQ(0u, mathfu::RoundUpToTypeBoundary<int64_t>(0));
  EXPECT_EQ(0u, mathfu::RoundUpToTypeBoundary<double>(0));
}
...
TEST_F(UtilitiesTests, RoundUpToTypeBoundary_AlreadyAligned) {
  ...
  EXPECT_EQ(1u, mathfu::RoundUpToTypeBoundary<char>(1));
  EXPECT_EQ(5u, mathfu::RoundUpToTypeBoundary<char>(5));

  // int32_t typically has alignment 4.
  size_t align4 = alignof(int32_t);
  EXPECT_EQ(align4, mathfu::RoundUpToTypeBoundary<int32_t>(align4));
  EXPECT_EQ(align4 * 2, mathfu::RoundUpToTypeBoundary<int32_t>(align4 * 2));
  EXPECT_EQ(align4 * 100, mathfu::RoundUpToTypeBoundary<int32_t>(align4 * 100));
}
...
TEST_F(UtilitiesTests, RoundUpToTypeBoundary_RoundsUp) {
  ...
  size_t align4 = alignof(int32_t);
  if (align4 == 4) {
    EXPECT_EQ(4u, mathfu::RoundUpToTypeBoundary<int32_t>(1));
    EXPECT_EQ(4u, mathfu::RoundUpToTypeBoundary<int32_t>(2));
    EXPECT_EQ(4u, mathfu::RoundUpToTypeBoundary<int32_t>(3));
    EXPECT_EQ(8u, mathfu::RoundUpToTypeBoundary<int32_t>(5));
    EXPECT_EQ(8u, mathfu::RoundUpToTypeBoundary<int32_t>(6));
    EXPECT_EQ(8u, mathfu::RoundUpToTypeBoundary<int32_t>(7));
  }

  // For double (alignment 8): 1 -> 8, 7 -> 8, 9 -> 16.
  size_t align8 = alignof(double);
  if (align8 == 8) {
    EXPECT_EQ(8u, mathfu::RoundUpToTypeBoundary<double>(1));
    EXPECT_EQ(8u, mathfu::RoundUpToTypeBoundary<double>(7));
    EXPECT_EQ(16u, mathfu::RoundUpToTypeBoundary<double>(9));
    EXPECT_EQ(16u, mathfu::RoundUpToTypeBoundary<double>(15));
  }
}
...
TEST_F(UtilitiesTests, RoundUpToTypeBoundary_CharAlignment) {
  for (size_t i = 0; i < 100; ++i) {
    EXPECT_EQ(i, mathfu::RoundUpToTypeBoundary<char>(i));
  }
}
...
TEST_F(UtilitiesTests, RoundUpToTypeBoundary_LargeValues) {
  ...
  if (sizeof(size_t) > 4) {
    ...
    EXPECT_EQ(large_value, mathfu::RoundUpToTypeBoundary<int32_t>(large_value));

    // 2^32 + 1 should round up to 2^32 + align.
    size_t expected = large_value + align;
    EXPECT_EQ(expected,
              mathfu::RoundUpToTypeBoundary<int32_t>(large_value + 1));
  }
}
...
TEST_F(UtilitiesTests, RoundUpToTypeBoundary_VariousTypes) {
  ...
  if (align2 == 2) {
    EXPECT_EQ(2u, mathfu::RoundUpToTypeBoundary<int16_t>(1));
